...
function HotelCard({ hotel, onViewDetails }) {
  const { thumbnail, name, location, description, rating, price } = hotel;
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col grow justify-between">
        <div>
          <div className="flex items-center text-xs font-semibold text-slate-500 mb-1.5 select-none gap-0.5 grow">
